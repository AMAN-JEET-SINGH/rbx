      ...
      <div className="w-full max-w-md mx-auto">
        ...
        <div className="flex items-center justify-center gap-4 text-white mb-4">
          <div className="flex items-center gap-2 bg-[#2a2a2a] px-4 py-2 rounded-lg">
            <img src="/rbxlogo.svg" alt="Coins" className="w-5 h-5" />
          ...
          <div className="relative flex flex-col items-center">
            <div className="relative w-80 h-80 mb-6">
              ...
              >
                ...
                <img src="/wheel-base.svg" alt="Wheel Base" className="w-full h-full absolute inset-0" />
              ...
              >
                <img src="/spin.svg" alt="Spin" className="w-14 h-14" />
              </button>
            </div>
